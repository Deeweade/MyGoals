...
namespace MyGoals.API.Migrations
{
    ...
    [Migration("20240312204811_BusinessProcessStagesAdded")]
    partial class BusinessProcessStagesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyGoals.Domain.Entities.EmployeeRequest", b =>
                {
                    ...
                    b.Property<int?>("GroupRequestId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyGoals.Domain.Entities.Goal", b =>
                {
                    ...
                    b.Property<int>("KeyResultTypeId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GoalTypeId1");

                    b.HasIndex("KeyResultTypeId");

                    b.HasIndex("KeyResultTypeId1");
            ...
            modelBuilder.Entity("MyGoals.Domain.Entities.EmployeeRequest", b =>
                {
                    b.HasOne("MyGoals.Domain.Entities.Employee", null)
                    ...
                    b.HasOne("MyGoals.Domain.Entities.GroupRequest", null)
                        .WithMany("EmployeeRequests")
                        .HasForeignKey("GroupRequestId");

                    b.HasOne("MyGoals.Domain.Entities.GroupRequest", "GroupRequest")
                        .WithMany()
                        .HasForeignKey("GroupRequestId1");

                    b.HasOne("MyGoals.Domain.Entities.Period", null)
                        .WithMany("EmployeeRequests")
                    ...
                    b.HasOne("MyGoals.Domain.Entities.RequestStatus", null)
                        .WithMany("EmployeeRequests")
